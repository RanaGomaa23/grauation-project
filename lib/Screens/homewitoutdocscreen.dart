...
import 'package:rafeeq/Screens/Trainingscreen.dart';
import 'package:rafeeq/Screens/trainingscreen2.dart';

class homewithoutdocscreen extends StatefulWidget {
  const homewithoutdocscreen({Key? key}) : super(key: key);

  @override
  State<homewithoutdocscreen> createState() => _homewithoutdocscreenState();
}

class _homewithoutdocscreenState extends State<homewithoutdocscreen> {
  bool task1 = false;
  bool task2 = false;
  bool task3 = false;
